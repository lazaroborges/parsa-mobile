...
class _DashboardPageState extends State<DashboardPage> with RouteAware {
    ...
    return StreamBuilder<bool>(
      ...
      builder: (context, forecastSnapshot) {
        if (forecastSnapshot.data == true) {
          return _buildForecastDashboard(context, t);
        }
        return _buildRealDashboard(context, t, userData);
      },
    );
  }

  Widget _buildForecastDashboard(BuildContext context, Translations t) {
    return Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    StreamBuilder<double>(
                      stream: ForecastTransactionService.instance
                          .getForecastTotals(
                        month: DateTime(
                    ...
                    // Net forecast
                    StreamBuilder<ForecastCountResult>(
                      stream: ForecastTransactionService.instance.countForecasts(),
                      builder: (context, snapshot) {
                        return _forecastSummaryRow(
                          context,
                          label: 'Saldo previsto',
                          amount: snapshot.data?.valueSum ?? 0,
                          color: (snapshot.data?.valueSum ?? 0) >= 0
                              ? Colors.green
                              : Colors.red,
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ForecastTransactionListComponent(
                      ...
                      heroTagBuilder: (tr) => 'dashboard-forecast-${tr.id}',
                      limit: 10,
  ...
  Widget _buildRealDashboard(BuildContext context, Translations t, Map<String, dynamic>? userData) {
    return Scaffold(
        appBar: EmptyAppBar(color: AppColors.of(context).light),
        drawer: null,
