...
class BudgetListCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CardWithHeader(
      title: title.isEmpty ? t.budgets.title : title,
      onHeaderButtonClick: () =>
          RouteUtils.pushRoute(context, const BudgetsPage()),
      headerButtonIcon: Icons.arrow_forward_ios_rounded,
      onHeaderTap: () => RouteUtils.pushRoute(context, const BudgetsPage()),
      bodyPadding: EdgeInsets.zero,
      body: budgets.isEmpty
          ? InkWell(
              onTap: () => RouteUtils.pushRoute(context, const BudgetsPage()),
              child: Padding(
                padding:
          ...
          : ListView.separated(
              ...
              itemCount: budgets.length > limit ? limit : budgets.length,
              shrinkWrap: true,
              ...
              itemBuilder: (context, index) {
                ...
                return _BudgetItem(budget: budget);
              },
            ),
    );
  }
