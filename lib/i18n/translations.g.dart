...
/// Strings: 615
///
/// Built on 2025-03-05 at 19:29 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  // Translations
  late final _TranslationsConnectionsPt connections =
      _TranslationsConnectionsPt._(_root);
  ...
  late final _TranslationsFinancialHealthPt financial_health =
      _TranslationsFinancialHealthPt._(_root);
  late final _TranslationsStatsPt stats = _TranslationsStatsPt._(_root);
  late final _TranslationsIconSelectorPt icon_selector =
      _TranslationsIconSelectorPt._(_root);
  late final _TranslationsTransactionPt transaction =
      _TranslationsTransactionPt._(_root);
  late final _TranslationsTransferPt transfer =
      _TranslationsTransferPt._(_root);
  late final _TranslationsRecurrentTransactionsPt recurrent_transactions =
      _TranslationsRecurrentTransactionsPt._(_root);
  late final _TranslationsAccountPt account = _TranslationsAccountPt._(_root);
  late final _TranslationsCurrenciesPt currencies =
      _TranslationsCurrenciesPt._(_root);
  late final _TranslationsTagsPt tags = _TranslationsTagsPt._(_root);
  late final _TranslationsCategoriesPt categories =
      _TranslationsCategoriesPt._(_root);
...
class _TranslationsConnectionsPt {
  ...
  // Translations
  String get success =>
      'Sincronização concluída com sucesso. Vamos analisar seus dados. Em um minuto, tente atualizar a tela para ver seus dados atualizados.';
  String get error =>
      'Ocorreu um erro ao sincronizar seus dados. Por favor, tente novamente mais tarde.';
}
...
class _TranslationsGeneralPt {
  ...
  late final _TranslationsGeneralClipboardPt clipboard =
      _TranslationsGeneralClipboardPt._(_root);
  late final _TranslationsGeneralTimePt time =
      _TranslationsGeneralTimePt._(_root);
  late final _TranslationsGeneralTransactionOrderPt transaction_order =
      _TranslationsGeneralTransactionOrderPt._(_root);
  late final _TranslationsGeneralValidationsPt validations =
      _TranslationsGeneralValidationsPt._(_root);
}
...
class _TranslationsIntroPt {
  ...
  String get welcome_footer =>
      'Ao entrar, você concorda com a <a href=\'https://github.com/enrique-lozano/Parsa/blob/main/docs/PRIVACY_POLICY.md\'>Política de Privacidade</a> e os <a href=\'https://github.com/enrique-lozano/Parsa/blob/main/docs/TERMS_OF_USE.md\'>Termos de Uso</a> do aplicativo';
  String get offline_descr_title => 'CONTA OFFLINE:';
  String get offline_descr =>
      'Seus dados serão armazenados apenas no seu dispositivo e estarão seguros enquanto você não desinstalar o aplicativo ou trocar de telefone. Para evitar a perda de dados, é recomendável fazer backup regularmente nas configurações do aplicativo.';
  String get offline_start => 'Iniciar sessão offline';
  String get sl1_title => 'Selecione sua moeda';
  String get sl1_descr =>
      'Sua moeda padrão será usada em relatórios e gráficos gerais. Você poderá alterar a moeda e o idioma do aplicativo mais tarde a qualquer momento nas configurações do aplicativo';
  String get sl2_title => 'Seguro, privado e confiável';
  String get sl2_descr =>
      'Seus dados são apenas seus. Armazenamos as informações diretamente no seu dispositivo, sem passar por servidores externos. Isso possibilita o uso do aplicativo mesmo sem internet';
  String get sl2_descr2 =>
      'Além disso, o código-fonte do aplicativo é público, qualquer pessoa pode colaborar e ver como ele funciona';
  String get last_slide_title => 'Tudo pronto';
  String get last_slide_descr =>
      'Com o Parsa, você finalmente pode alcançar a independência financeira que tanto deseja. Você terá gráficos, orçamentos, dicas, insights e muito mais sobre seu dinheiro.';
  String get last_slide_descr2 =>
      'Esperamos que aproveite sua experiência! Não hesite em nos contatar em caso de dúvidas, sugestões...';
}
...
class _TranslationsHomePt {
  ...
  String get total_balance_tooltip =>
      'Soma de todos os saldos das suas contas menos os saldos do cartão de crédito e empréstimos.';
  String get available_balance => 'Saldo disponível';
  String get available_balance_tooltip =>
      'Soma de todos os saldos das suas contas menos os saldos do cartão de crédito e empréstimos.';
  String get future_balance => 'Saldo futuro';
  String get future_balance_tooltip =>
      'Soma de todos os saldos das suas contas menos os saldos do cartão de crédito e empréstimos.';
  ...
  String get no_accounts_descr =>
      'Comece a usar toda a magia do Parsa. Crie pelo menos uma conta para começar a adicionar transações';
  ...
  String get should_create_account_message =>
      'Você deve ter pelo menos uma conta não arquivada antes de começar a criar transações';
}
...
class _TranslationsFinancialHealthPt {
  ...
  late final _TranslationsFinancialHealthReviewPt review =
      _TranslationsFinancialHealthReviewPt._(_root);
  late final _TranslationsFinancialHealthMonthsWithoutIncomePt
      months_without_income =
      _TranslationsFinancialHealthMonthsWithoutIncomePt._(_root);
  late final _TranslationsFinancialHealthSavingsPercentagePt
      savings_percentage =
      _TranslationsFinancialHealthSavingsPercentagePt._(_root);
}
...
class _TranslationsIconSelectorPt {
  ...
  late final _TranslationsIconSelectorScopesPt scopes =
      _TranslationsIconSelectorScopesPt._(_root);
}
...
class _TranslationsTransactionPt {
  ...
  String get yes => 'Sim';
  String get no => 'Não';
  String get delete_openfinance_error =>
      'Não é possível deletar transações do Open Finance. Caso voc�� queira desconsiderar uma transação, use a opção \'Desconsiderada\' dentro do card da transação.';
  ...
  String edit_multiple_success({required Object x}) =>
      '${x} transações editadas com sucesso';
  String get duplicate => 'Clonar transação';
  String get duplicate_short => 'Clonar';
  String get duplicate_warning_message =>
      'Uma transação idêntica a esta será criada com a mesma data, deseja continuar?';
  ...
  String get delete_warning_message =>
      'Essa ação é irreversível. Prefira usar o status \'Desconsiderada\' para remover a transação das suas análises. O saldo atual de suas contas e todas as suas análises serão recalculados';
  ...
  String delete_multiple_warning_message({required Object x}) =>
      'Essa ação é irreversível e removerá ${x} transações. O saldo atual de suas contas e todas as suas análises serão recalculados';
  String delete_multiple_success({required Object x}) =>
      '${x} transações excluídas com sucesso';
  String get details => 'Detalhes da transação';
  String get transaction_cousin => 'Transações Similares';
  late final _TranslationsTransactionNextPaymentsPt next_payments =
      _TranslationsTransactionNextPaymentsPt._(_root);
  late final _TranslationsTransactionListPt list =
      _TranslationsTransactionListPt._(_root);
  late final _TranslationsTransactionFiltersPt filters =
      _TranslationsTransactionFiltersPt._(_root);
  late final _TranslationsTransactionFormPt form =
      _TranslationsTransactionFormPt._(_root);
  late final _TranslationsTransactionNotesPt notes =
      _TranslationsTransactionNotesPt._(_root);
  late final _TranslationsTransactionReversedPt reversed =
      _TranslationsTransactionReversedPt._(_root);
  late final _TranslationsTransactionStatusPt status =
      _TranslationsTransactionStatusPt._(_root);
  late final _TranslationsTransactionTypesPt types =
      _TranslationsTransactionTypesPt._(_root);
}
...
class _TranslationsTransferPt {
  ...
  String get need_two_accounts_warning_message =>
      'São necessárias pelo menos duas contas para realizar esta ação. Se precisar ajustar ou editar o saldo atual desta conta, clique no botão de edição';
  late final _TranslationsTransferFormPt form =
      _TranslationsTransferFormPt._(_root);
}
...
class _TranslationsRecurrentTransactionsPt {
  ...
  String get empty =>
      'Parece que você não tem nenhuma transação recorrente. Crie uma transação recorrente mensal, anual ou semanal e ela aparecerá aqui';
  String get total_expense_title => 'Despesa total por período';
  String get total_expense_descr =>
      '* Sem considerar a data de início e término de cada recorrência';
  late final _TranslationsRecurrentTransactionsDetailsPt details =
      _TranslationsRecurrentTransactionsDetailsPt._(_root);
}
...
class _TranslationsAccountPt {
  ...
  String get no_accounts =>
      'Nenhuma transação encontrada para exibir aqui. Adicione uma transação clicando no botão \'+\' na parte inferior';
  late final _TranslationsAccountTypesPt types =
      _TranslationsAccountTypesPt._(_root);
  late final _TranslationsAccountFormPt form =
      _TranslationsAccountFormPt._(_root);
  late final _TranslationsAccountDisconnectPt disconnect =
      _TranslationsAccountDisconnectPt._(_root);
  late final _TranslationsAccountRemovePt remove =
      _TranslationsAccountRemovePt._(_root);
  late final _TranslationsAccountRestorePt restore =
      _TranslationsAccountRestorePt._(_root);
  late final _TranslationsAccountDeleteOpenfinancePt delete_openfinance =
      _TranslationsAccountDeleteOpenfinancePt._(_root);
  late final _TranslationsAccountDeletePt delete =
      _TranslationsAccountDeletePt._(_root);
  late final _TranslationsAccountClosePt close =
      _TranslationsAccountClosePt._(_root);
  late final _TranslationsAccountSelectPt select =
      _TranslationsAccountSelectPt._(_root);
  late final _TranslationsAccountConnectionErrorsPt connection_errors =
      _TranslationsAccountConnectionErrorsPt._(_root);
}
...
class _TranslationsCurrenciesPt {
  ...
  String get currency_manager_descr =>
      'Configure sua moeda e suas taxas de câmbio com outras';
  ...
  String get change_preferred_currency_msg =>
      'Todas as insights e orçamentos serão exibidos nesta moeda a partir de agora. Contas e transações manterão a moeda que possuíam. Todas as taxas de câmbio salvas serão excluídas se você executar esta ação. Deseja continuar?';
  late final _TranslationsCurrenciesFormPt form =
      _TranslationsCurrenciesFormPt._(_root);
  ...
  String get empty =>
      'Adicione taxas de câmbio aqui para que se você tiver contas em moedas diferentes da sua moeda base, nossos gráficos sejam mais precisos';
...
class _TranslationsTagsPt {
  ...
  String get empty_list =>
      'Você ainda não criou nenhuma tag. Tags e categorias são uma ótima maneira de categorizar suas transações';
  ...
  String get already_exists =>
      'Este nome de tag já existe. Talvez você queira editá-lo';
  ...
  String get delete_warning_message =>
      'Essa ação não excluirá as transações que possuem essa tag.';
  String get no_tags =>
      'Transação sem tags. Clique aqui para adicionar uma tag.';
}
...
class _TranslationsCategoriesPt {
  ...
  String get already_exists =>
      'O nome desta categoria já existe. Talvez você queira editá-la';
  ...
  String make_child_warning1({required Object destiny}) =>
      'Esta categoria e suas subcategorias se tornarão subcategorias de <b>${destiny}</b>.';
  String make_child_warning2({required Object x, required Object destiny}) =>
      'Suas transações <b>(${x})</b> serão movidas para as novas subcategorias criadas dentro da categoria <b>${destiny}</b>.';
  ...
  String merge_warning1(
      ...
      'Todas as transações (${x}) associadas à categoria <b>${from}</b> serão movidas para a categoria <b>${destiny}</b>';
  String merge_warning2({required Object from}) =>
      'A categoria <b>${from}</b> será excluída de forma irreversível.';
  ...
  String delete_warning_message({required Object x}) =>
      'Essa ação excluirá de forma irreversível todas as transações <b>(${x})</b> relacionadas a esta categoria.';
  late final _TranslationsCategoriesSelectPt select =
      _TranslationsCategoriesSelectPt._(_root);
}
...
class _TranslationsBudgetsPt {
  ...
  String get no_budgets =>
      'Os dados de orçamentos ainda não são salvos na nuvem. Parece não haver orçamentos para exibir nesta seção. Comece criando um orçamento clicando no botão abaixo';
  String get delete => 'Excluir orçamento';
  String get delete_warning =>
      'Essa ação é irreversível. Categorias e transações referentes a esta cota não serão excluídas';
  late final _TranslationsBudgetsFormPt form =
      _TranslationsBudgetsFormPt._(_root);
  late final _TranslationsBudgetsDetailsPt details =
      _TranslationsBudgetsDetailsPt._(_root);
}
...
class _TranslationsBackupPt {
  ...
  // Translations
  late final _TranslationsBackupExportPt export =
      _TranslationsBackupExportPt._(_root);
  late final _TranslationsBackupImportPt import =
      _TranslationsBackupImportPt._(_root);
  late final _TranslationsBackupAboutPt about =
      _TranslationsBackupAboutPt._(_root);
}
...
class _TranslationsSettingsPt {
  ...
  String get lang_descr =>
      'Idioma em que os textos serão exibidos no aplicativo';
  String get locale => 'Região';
  String get locale_descr =>
      'Defina o formato a ser usado para datas, números...';
  ...
  String get amoled_mode_descr =>
      'Use um papel de parede preto puro sempre que possível. Isso ajudará um pouco na bateria de dispositivos com telas AMOLED';
  String get dynamic_colors => 'Cores dinâmicas';
  String get dynamic_colors_descr =>
      'Use a cor de destaque do sistema sempre que possível';
  String get accent_color => 'Cor de destaque';
  String get accent_color_descr =>
      'Escolha a cor que o aplicativo usará para destacar certas partes da interface';
  late final _TranslationsSettingsSecurityPt security =
      _TranslationsSettingsSecurityPt._(_root);
}
...
class _TranslationsMorePt {
  ...
  late final _TranslationsMoreSubscribePt subscribe =
      _TranslationsMoreSubscribePt._(_root);
  late final _TranslationsMoreAboutUsPt about_us =
      _TranslationsMoreAboutUsPt._(_root);
  late final _TranslationsMoreHelpUsPt help_us =
      _TranslationsMoreHelpUsPt._(_root);
}
...
class _TranslationsAuthPt {
  ...
  String get login_reason =>
      'Por favor, confirme sua biometria para continuar. ';
  String get login_error =>
      'Erro ao fazer login. Por favor, verifique suas credenciais e conexão de rede.';
  String get biometric_failed =>
      'Autenticação biométrica falhou. Por favor, faça o login novamente.';
...
class _TranslationsGeneralClipboardPt {
  ...
  String success({required Object x}) =>
      '${x} copiado para a área de transferência';
...
class _TranslationsGeneralTimePt {
  ...
  late final _TranslationsGeneralTimeRangesPt ranges =
      _TranslationsGeneralTimeRangesPt._(_root);
  late final _TranslationsGeneralTimePeriodicityPt periodicity =
      _TranslationsGeneralTimePeriodicityPt._(_root);
  late final _TranslationsGeneralTimeCurrentPt current =
      _TranslationsGeneralTimeCurrentPt._(_root);
  late final _TranslationsGeneralTimeAllPt all =
      _TranslationsGeneralTimeAllPt._(_root);
}
...
class _TranslationsFinancialHealthReviewPt {
  ...
  late final _TranslationsFinancialHealthReviewDescrPt descr =
      _TranslationsFinancialHealthReviewDescrPt._(_root);
}
...
class _TranslationsFinancialHealthMonthsWithoutIncomePt {
  ...
  String get subtitle =>
      'Dado seu saldo, tempo que você poderia viver sem renda';
  String get text_zero =>
      'Você não conseguiria sobreviver um mês sem renda neste ritmo de despesas!';
  String get text_one =>
      'Você mal conseguiria sobreviver aproximadamente um mês sem renda neste ritmo de despesas!';
  String text_other({required Object n}) =>
      'Você conseguiria sobreviver aproximadamente <b>${n} meses</b> sem renda neste ritmo de despesas.';
  String get text_infinite =>
      'Você conseguiria sobreviver aproximadamente <b>toda a vida</b> sem renda neste ritmo de despesas.';
  String get suggestion =>
      'Lembre-se de que é aconselhável sempre manter essa proporção acima de 5 meses, pelo menos. Se você perceber que não tem uma reserva de emergência suficiente, reduza as despesas desnecessárias.';
  String get insufficient_data =>
      'Parece que não temos despesas suficientes para calcular quantos meses você poderia sobreviver sem renda. Insira algumas transações e volte aqui para verificar sua saúde financeira';
}
...
class _TranslationsFinancialHealthSavingsPercentagePt {
  ...
  late final _TranslationsFinancialHealthSavingsPercentageTextPt text =
      _TranslationsFinancialHealthSavingsPercentageTextPt._(_root);
  String get suggestion =>
      'Lembre-se de que é aconselhável economizar pelo menos 15-20% do que você ganha.';
}
...
class _TranslationsTransactionNextPaymentsPt {
  ...
  String skip_dialog_msg({required Object date}) =>
      'Essa ação é irreversível. Vamos mover a data da próxima transação para ${date}';
  String get accept_today => 'Aceitar hoje';
  String accept_in_required_date({required Object date}) =>
      'Aceitar na data requerida (${date})';
  String get accept_dialog_title => 'Aceitar transação';
  String get accept_dialog_msg_single =>
      'O novo status da transação será nulo. Você pode re-editar o status dessa transação sempre que quiser';
  String accept_dialog_msg({required Object date}) =>
      'Essa ação criará uma nova transação com data ${date}. Você poderá verificar os detalhes desta transação na página de transações';
  String get recurrent_rule_finished =>
      'A regra recorrente foi concluída, não há mais pagamentos a serem feitos!';
}
...
class _TranslationsTransactionListPt {
  ...
  String get searcher_no_results =>
      'Nenhuma transação encontrada correspondente aos critérios de pesquisa';
  ...
  late final _TranslationsTransactionListBulkEditPt bulk_edit =
      _TranslationsTransactionListBulkEditPt._(_root);
}
...
class _TranslationsTransactionFormPt {
  ...
  // Translations
  late final _TranslationsTransactionFormValidatorsPt validators =
      _TranslationsTransactionFormValidatorsPt._(_root);
  ...
  String get description_info =>
      'Toque aqui para inserir uma descrição mais detalhada sobre esta transação';
  String exchange_to_preferred_title({required Object currency}) =>
      'Taxa de câmbio para ${currency}';
...
class _TranslationsTransactionReversedPt {
  ...
  String get description_for_expenses =>
      'AINDA NÃO FUNCIONA Apesar de ser uma transação de despesa, ela tem um valor positivo. Esses tipos de transações podem ser usados para representar o retorno de uma despesa previamente registrada, como um reembolso ou o pagamento de uma dívida.';
  String get description_for_incomes =>
      'AINDA NÃO FUNCIONA Apesar de ser uma transação de receita, ela tem um valor negativo. Esses tipos de transações podem ser usados para anular ou corrigir uma receita que foi registrada incorretamente, para refletir um retorno ou reembolso de dinheiro ou para registrar o pagamento de dívidas.';
}
...
class _TranslationsTransactionStatusPt {
  ...
  String get reconciled_descr =>
      'Esta transação conta para seus insights e saldos.';
  String get unreconciled => 'Não considerada';
  String get unreconciled_descr =>
      'Esta transação ainda não foi validada e, portanto, ainda não aparece em suas contas bancárias reais. No entanto, ela conta para o cálculo de saldos e insights no Parsa';
  String get notconsidered => 'Desconsiderada';
  String get notconsidered_descr =>
      'Esta transação não conta para seus insights e saldos.';
  String get pending => 'Pendente';
  String get pending_descr =>
      'Esta transação está pendente e, portanto, não será considerada no cálculo de saldos e insights';
  String get voided => 'Anulada';
  String get voided_descr =>
      'Transação anulada/cancelada devido a erro de pagamento ou qualquer outro motivo. Ela não será considerada no cálculo de saldos e insights';
}
...
class _TranslationsTransferFormPt {
  ...
  late final _TranslationsTransferFormValueInDestinyPt value_in_destiny =
      _TranslationsTransferFormValueInDestinyPt._(_root);
}
...
class _TranslationsRecurrentTransactionsDetailsPt {
  ...
  String get descr =>
      'As próximas transações para esta operação estão listadas abaixo. Você pode aceitar a primeira transação ou optar por ignorá-la';
  String get last_payment_info =>
      'Esta transação é a última da regra recorrente, portanto, a regra será automaticamente excluída ao confirmar esta ação';
  String get delete_header => 'Excluir transação recorrente';
  String get delete_message =>
      'Esta ação é irreversível e não afetará as transações que você já confirmou/pagou';
}
...
class _TranslationsAccountTypesPt {
  ...
  String get warning =>
      'Uma vez escolhido o tipo de conta, ele não poderá ser alterado no futuro';
  String get normal => 'Conta corrente';
  String get normal_descr =>
      'Útil para registrar suas finanças do dia a dia. É a conta mais comum, permite adicionar despesas, receitas...';
  String get saving => 'Investimentos';
  String get saving_descr =>
      'Você só poderá adicionar e retirar dinheiro dela a partir de outras contas. Perfeito para começar a economizar';
  String get credit => 'Cartão de crédito';
  String get credit_descr =>
      'Conta que simula uma conta corrente, porém com um saldo negativo. Útil para simular compras parceladas, empréstimos, financiamentos, etc';
  String get wallet => 'Carteira';
  String get wallet_descr =>
      'Para controlar dinheiro físico (eca!). Usuários Premium terão saques automaticamente creditados nesta conta.';
}
...
class _TranslationsAccountFormPt {
  ...
  String get notes_placeholder =>
      'Digite algumas notas/descrição sobre esta conta';
  ...
  String get currency_not_found_warn =>
      'Você não tem informações sobre taxas de câmbio para esta moeda. 1.0 será usado como a taxa de câmbio padrão. Você pode modificar isso nas configurações';
  String get already_exists =>
      'Já existe outra com o mesmo nome, por favor escreva outro';
  String get tr_before_opening_date =>
      'Existem transações nesta conta com uma data anterior à data de abertura';
...
class _TranslationsAccountDisconnectPt {
  ...
  String get warning_text =>
      'Esta ação cancelerá seu consentimento com o seu banco e não poderemos mais sincronizar suas transações. Esta ação afetará também outros produtos do mesmo banco. Suas transações ainda permanecerão guardadas no Parsa.';
...
class _TranslationsAccountRemovePt {
  ...
  String get warning_text =>
      'Está ação irá remover esta conta da interface do Parsa, mas seu banco e outras contas continuarão sendo sincronizadas. Esta ação é totalmente reversível. Você deseja continuar?';
...
class _TranslationsAccountRestorePt {
  ...
  String get warning_text =>
      'Está ação irá trazer de volta para sincronização automática continua esta conta que você parou de sincronizar. Você gostaria de prosseguir com esta ação?';
  String get success => 'Conta restaurada com sucesso.';
  String get in_progress =>
      'Restauração da Conta em Andamento. Você pode continuar usando o app.';
}
...
class _TranslationsAccountDeleteOpenfinancePt {
  ...
  String get warning_header => 'Deletar?';
  String get warning_text =>
      'Está ação irá remover seu consentimento com o seu banco, interromperá a sincronização de todas as contas e transações neste banco e excluirá todas as suas transações desta conta no Parsa. Deseja prosseguir?';
...
class _TranslationsAccountDeletePt {
  ...
  String get warning_text =>
      'Essa ação excluirá essa conta e todas as suas transações';
...
class _TranslationsAccountClosePt {
  ...
  String get warn =>
      'Esta conta não aparecerá mais em determinados listagens e você não poderá criar transações nela com uma data posterior à especificada abaixo. Esta ação não afeta nenhuma transação ou saldo, e você também pode reabrir esta conta a qualquer momento.';
  String get should_have_zero_balance =>
      'Você deve ter um saldo atual de 0 nesta conta para fechá-la. Por favor, edite a conta antes de continuar';
  String get should_have_no_transactions =>
      'Esta conta possui transações após a data de fechamento especificada. Exclua-as ou edite a data de fechamento da conta antes de continuar';
...
class _TranslationsAccountConnectionErrorsPt {
  ...
  String get not_subscribed =>
      'Você ainda não é assinante do plano Premium. Por favor, assine o plano Premium para conectar suas contas com o Open Finance.';
  String get limit_reached =>
      'Você atingiu o limite de 3 contas conectadas. Tente desconectar uma conta para adicionar outra.';
  String get daily_limit_reached =>
      'O sistema atingiu o limite de conexões diárias. Por favor, tente novamente amanhã.';
  String get default_message =>
      'Não foi possível conectar no momento. Tente novamente mais tarde.';
}
...
class _TranslationsCurrenciesFormPt {
  ...
  String get equal_to_preferred_warn =>
      'A moeda não pode ser igual à moeda do usuário';
...
class _TranslationsBudgetsDetailsPt {
  ...
  String expend_diary_left(
      ...
      'Você pode gastar ${dailyAmount}/dia pelos ${remainingDays} dias restantes';
  String get expend_evolution => 'Evolução dos gastos';
  String get no_transactions =>
      'Parece que você não fez nenhuma despesa relacionada a este orçamento';
}
...
class _TranslationsBackupExportPt {
  ...
  String get all_descr =>
      'Exporte todos os seus dados (contas, transações, orçamentos, configurações...). Importe-os novamente a qualquer momento para não perder nada.';
  String get transactions => 'Backup de transações';
  String get transactions_descr =>
      'Exporte suas transações em CSV para que você possa analisá-las mais facilmente em outros programas ou aplicativos.';
  String get description =>
      'Baixe os dados da suas transações em formato CSV. Recomendamos o uso do Google Sheets para abrir o arquivo por primeira vez - de lá você poderá exportar o arquivo para o Excel.';
  String get dialog_title => 'Salvar/Enviar arquivo';
  String success({required Object x}) =>
      'Arquivo salvo/baixado com sucesso em ${x}';
  String get error =>
      'Erro ao baixar o arquivo. Entre em contato com o desenvolvedor via lozin.technologies@gmail.com';
}
...
class _TranslationsBackupImportPt {
  ...
  String get restore_backup_descr =>
      'Importe um banco de dados salvo anteriormente do Parsa. Esta ação substituirá todos os dados atuais do aplicativo pelos novos dados';
  String get restore_backup_warn_description =>
      'Ao importar um novo banco de dados, você perderá todos os dados atualmente salvos no aplicativo. Recomenda-se fazer um backup antes de continuar. Não carregue aqui nenhum arquivo cuja origem você não conheça, carregue apenas arquivos que você tenha baixado anteriormente do Parsa';
  ...
  late final _TranslationsBackupImportManualImportPt manual_import =
      _TranslationsBackupImportManualImportPt._(_root);
  String get success => 'Importação realizada com sucesso';
  String get cancelled => 'A importação foi cancelada pelo usuário';
  String get error =>
      'Erro ao importar arquivo. Entre em contato com o desenvolvedor via lozin.technologies@gmail.com';
}
...
class _TranslationsSettingsSecurityPt {
  ...
  String get private_mode_at_launch_descr =>
      'Inicie o aplicativo no modo privado por padrão';
...
class _TranslationsMoreDataPt {
  ...
  String get delete_all_message1 =>
      'Tem certeza de que deseja continuar? Todos os seus dados serão excluídos permanentemente e não poderão ser recuperados';
  String get delete_all_header2 => 'Último passo ⚠️⚠️';
  String get delete_all_message2 =>
      'Ao excluir uma conta, você excluirá todos os seus dados pessoais armazenados. Suas contas, transações, orçamentos e categorias serão excluídos e não poderão ser recuperados. Você concorda?';
}
...
class _TranslationsMoreSubscribePt {
  ...
  String get description =>
      'Assine o Parsa para desbloquear todos os recursos Premium.';
  ...
  String confirm_message({required Object price}) =>
      'Você está prestes a assinar o Parsa Premium por ${price}. Deseja continuar?';
  String get no_plans_available => 'Nenhum plano disponível no momento';
  String get success => 'Assinatura realizada com sucesso!';
  String get error =>
      'Erro ao processar a assinatura. Por favor, tente novamente.';
  String get cancel => 'Cancelar';
}
...
class _TranslationsMoreAboutUsPt {
  ...
  String get description =>
      'Informações sobre o Parsa, entre em contato conosco, envie sugestões, etc. ';
  late final _TranslationsMoreAboutUsLegalPt legal =
      _TranslationsMoreAboutUsLegalPt._(_root);
  late final _TranslationsMoreAboutUsProjectPt project =
      _TranslationsMoreAboutUsProjectPt._(_root);
}
...
class _TranslationsMoreHelpUsPt {
  ...
  String get description =>
      'Descubra como você pode ajudar o Parsa a ficar cada vez melhor';
  ...
  String get share_descr =>
      'Compartilhe nosso aplicativo com amigos e familiares';
  String get share_text =>
      'Parsa! O melhor aplicativo de finanças pessoais. Baixe aqui';
  String get thanks => 'Obrigado!';
  String get thanks_long =>
      'Suas contribuições para o Parsa e outros projetos de código aberto, grandes e pequenos, tornam possíveis grandes projetos como este. Obrigado por dedicar seu tempo para contribuir.';
  String get donate => 'Faça uma doação';
  String get donate_descr =>
      'Com sua doação, você ajudará o aplicativo a continuar recebendo melhorias. Que melhor maneira de agradecer pelo trabalho feito do que me convidar para um café?';
  String get donate_success =>
      'Doação realizada. Muito obrigado pela sua contribuição! ❤️';
  String get donate_err =>
      'Oops! Parece que houve um erro ao receber seu pagamento';
...
class _TranslationsGeneralTimeRangesPt {
  ...
  late final _TranslationsGeneralTimeRangesTypesPt types =
      _TranslationsGeneralTimeRangesTypesPt._(_root);
...
class _TranslationsFinancialHealthReviewDescrPt {
  ...
  // Translations
  String get insufficient_data =>
      'Você não possui atividade financeira no período para que possamos calcular sua saúde financeira. Conecte uma conta bancária agora mesmo para começar a monitorar suas finanças!';
  String get very_good =>
      'Parabéns! Sua saúde financeira está excelente. Esperamos que continue em sua boa fase e continue aprendendo com o Parsa. (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
  String get good =>
      'Ótimo! Sua saúde financeira está boa. Visite a aba de Insights para ver como economizar ainda mais! (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
  String get normal =>
      'Sua saúde financeira está mais ou menos na média do restante da população para este período (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
  String get bad =>
      'Parece que sua situação financeira ainda não é das melhores. Explore o restante dos gráficos para aprender mais sobre suas finanças. (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
  String get very_bad =>
      'Hmm, sua saúde financeira está muito abaixo do esperado. Explore o restante dos gráficos para aprender mais sobre suas finanças (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
}
...
class _TranslationsFinancialHealthSavingsPercentageTextPt {
  ...
  String good({required Object value}) =>
      'Parabéns! Você conseguiu economizar <b>${value}%</b> da sua renda durante este período. Parece que você já é um especialista, continue assim!';
  String normal({required Object value}) =>
      'Parabéns, você conseguiu economizar <b>${value}%</b> da sua renda durante este período.';
  String bad({required Object value}) =>
      'Você conseguiu economizar <b>${value}%</b> da sua renda durante este período. No entanto, achamos que você ainda pode fazer muito mais!';
  String get very_bad =>
      'Você não conseguiu economizar nada durante este período.';
}
...
class _TranslationsTransactionFormValidatorsPt {
  ...
  String get date_max =>
      'A data selecionada é posterior à atual. A transação será adicionada como pendente';
  String get date_after_account_creation =>
      'Você não pode criar uma transação cuja data seja anterior à data de criação da conta a que pertence';
  String get negative_transfer =>
      'O valor monetário de uma transferência não pode ser negativo';
...
class _TranslationsBackupImportManualImportPt {
  ...
  String get descr =>
      'Importe transações de um arquivo .csv manualmente. Se você estiver usando sincronização do Open Finance, por favor não inclua transações do período de sincronização para evitar duplicidade.';
  ...
  String success({required Object x}) =>
      'Importado com sucesso ${x} transações';
}
...
class _TranslationsMoreAboutUsProjectPt {
  ...
  String get contributors_descr =>
      'Todos os desenvolvedores que ajudaram o Parsa a crescer';
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'connections.success':
        return 'Sincronização concluída com sucesso. Vamos analisar seus dados. Em um minuto, tente atualizar a tela para ver seus dados atualizados.';
      case 'connections.error':
        return 'Ocorreu um erro ao sincronizar seus dados. Por favor, tente novamente mais tarde.';
      case 'general.cancel':
        return 'Cancelar';
      case 'general.or':
        return 'ou';
      ...
      case 'general.time.ranges.types.last_days_form':
        return ({required Object x}) => '${x} dias anteriores';
      ...
      case 'general.validations.min_number':
        return ({required Object x}) => 'Deve ser maior que ${x}';
      case 'general.validations.max_number':
        return ({required Object x}) => 'Deve ser menor que ${x}';
      case 'intro.start':
        return 'Começar';
      case 'intro.skip':
        return 'Pular';
      ...
      case 'intro.select_your_currency':
        return 'Selecione sua moeda';
      case 'intro.welcome_subtitle':
        return 'Seu gerente financeiro pessoal';
      case 'intro.welcome_subtitle2':
        return 'Controle Financeiro sem esforço.';
      case 'intro.welcome_footer':
        return 'Ao entrar, você concorda com a <a href=\'https://github.com/enrique-lozano/Parsa/blob/main/docs/PRIVACY_POLICY.md\'>Política de Privacidade</a> e os <a href=\'https://github.com/enrique-lozano/Parsa/blob/main/docs/TERMS_OF_USE.md\'>Termos de Uso</a> do aplicativo';
      case 'intro.offline_descr_title':
        return 'CONTA OFFLINE:';
      case 'intro.offline_descr':
        return 'Seus dados serão armazenados apenas no seu dispositivo e estarão seguros enquanto você não desinstalar o aplicativo ou trocar de telefone. Para evitar a perda de dados, é recomendável fazer backup regularmente nas configurações do aplicativo.';
      case 'intro.offline_start':
        return 'Iniciar sessão offline';
      case 'intro.sl1_title':
        return 'Selecione sua moeda';
      case 'intro.sl1_descr':
        return 'Sua moeda padrão será usada em relatórios e gráficos gerais. Você poderá alterar a moeda e o idioma do aplicativo mais tarde a qualquer momento nas configurações do aplicativo';
      case 'intro.sl2_title':
        return 'Seguro, privado e confiável';
      case 'intro.sl2_descr':
        return 'Seus dados são apenas seus. Armazenamos as informações diretamente no seu dispositivo, sem passar por servidores externos. Isso possibilita o uso do aplicativo mesmo sem internet';
      case 'intro.sl2_descr2':
        return 'Além disso, o código-fonte do aplicativo é público, qualquer pessoa pode colaborar e ver como ele funciona';
      case 'intro.last_slide_title':
        return 'Tudo pronto';
      case 'intro.last_slide_descr':
        return 'Com o Parsa, você finalmente pode alcançar a independência financeira que tanto deseja. Você terá gráficos, orçamentos, dicas, insights e muito mais sobre seu dinheiro.';
      case 'intro.last_slide_descr2':
        return 'Esperamos que aproveite sua experiência! Não hesite em nos contatar em caso de dúvidas, sugestões...';
      case 'home.title':
        return 'Início';
      case 'home.filter_transactions':
        return 'Filtrar transações';
      case 'home.hello_day':
        return 'Bom dia,';
      ...
      case 'home.total_balance_tooltip':
        return 'Soma de todos os saldos das suas contas menos os saldos do cartão de crédito e empréstimos.';
      case 'home.available_balance':
        return 'Saldo disponível';
      case 'home.available_balance_tooltip':
        return 'Soma de todos os saldos das suas contas menos os saldos do cartão de crédito e empréstimos.';
      case 'home.future_balance':
        return 'Saldo futuro';
      case 'home.future_balance_tooltip':
        return 'Soma de todos os saldos das suas contas menos os saldos do cartão de crédito e empréstimos.';
      ...
      case 'home.no_accounts_descr':
        return 'Comece a usar toda a magia do Parsa. Crie pelo menos uma conta para começar a adicionar transações';
      ...
      case 'home.should_create_account_message':
        return 'Você deve ter pelo menos uma conta não arquivada antes de começar a criar transações';
      ...
      case 'financial_health.review.descr.insufficient_data':
        return 'Você não possui atividade financeira no período para que possamos calcular sua saúde financeira. Conecte uma conta bancária agora mesmo para começar a monitorar suas finanças!';
      case 'financial_health.review.descr.very_good':
        return 'Parabéns! Sua saúde financeira está excelente. Esperamos que continue em sua boa fase e continue aprendendo com o Parsa. (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
      case 'financial_health.review.descr.good':
        return 'Ótimo! Sua saúde financeira está boa. Visite a aba de Insights para ver como economizar ainda mais! (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
      case 'financial_health.review.descr.normal':
        return 'Sua saúde financeira está mais ou menos na média do restante da população para este período (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
      case 'financial_health.review.descr.bad':
        return 'Parece que sua situação financeira ainda não é das melhores. Explore o restante dos gráficos para aprender mais sobre suas finanças. (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
      case 'financial_health.review.descr.very_bad':
        return 'Hmm, sua saúde financeira está muito abaixo do esperado. Explore o restante dos gráficos para aprender mais sobre suas finanças (Este recurso ainda é experimental e não deve ser considerado como uma ferramenta de decisão financeira).';
      case 'financial_health.months_without_income.title':
        return 'Taxa de sobrevivência';
      case 'financial_health.months_without_income.subtitle':
        return 'Dado seu saldo, tempo que você poderia viver sem renda';
      case 'financial_health.months_without_income.text_zero':
        return 'Você não conseguiria sobreviver um mês sem renda neste ritmo de despesas!';
      case 'financial_health.months_without_income.text_one':
        return 'Você mal conseguiria sobreviver aproximadamente um mês sem renda neste ritmo de despesas!';
      case 'financial_health.months_without_income.text_other':
        return ({required Object n}) =>
            'Você conseguiria sobreviver aproximadamente <b>${n} meses</b> sem renda neste ritmo de despesas.';
      case 'financial_health.months_without_income.text_infinite':
        return 'Você conseguiria sobreviver aproximadamente <b>toda a vida</b> sem renda neste ritmo de despesas.';
      case 'financial_health.months_without_income.suggestion':
        return 'Lembre-se de que é aconselhável sempre manter essa proporção acima de 5 meses, pelo menos. Se você perceber que não tem uma reserva de emergência suficiente, reduza as despesas desnecessárias.';
      case 'financial_health.months_without_income.insufficient_data':
        return 'Parece que não temos despesas suficientes para calcular quantos meses você poderia sobreviver sem renda. Insira algumas transações e volte aqui para verificar sua saúde financeira';
      case 'financial_health.savings_percentage.title':
        return 'Porcentagem de economia';
      case 'financial_health.savings_percentage.subtitle':
        return 'Qual parte da sua renda não foi gasta neste período';
      ...
      case 'financial_health.savings_percentage.text.very_bad':
        return 'Você não conseguiu economizar nada durante este período.';
      case 'financial_health.savings_percentage.suggestion':
        return 'Lembre-se de que é aconselhável economizar pelo menos 15-20% do que você ganha.';
      case 'stats.title':
        return 'Insights';
      case 'stats.balance':
        return 'Saldo';
      ...
      case 'icon_selector.select_account_icon':
        return 'Identifique sua conta';
      case 'icon_selector.select_category_icon':
        return 'Identifique sua categoria';
      ...
      case 'transaction.source':
        return 'Origem';
      case 'transaction.openfinance_source':
        return 'Open Finance';
      case 'transaction.manual_source':
        return 'Manual';
      case 'transaction.manipulated':
        return 'Modificada pelo usuário';
      case 'transaction.synch_method':
        return 'Sincronizada';
      case 'transaction.synch_auto':
        return 'Automaticamente (Open Finance)';
      case 'transaction.synch_manual':
        return 'Manualmente';
      case 'transaction.yes':
        return 'Sim';
      case 'transaction.no':
        return 'Não';
      case 'transaction.delete_openfinance_error':
        return 'Não é possível deletar transações do Open Finance. Caso voc�� queira desconsiderar uma transação, use a opção \'Desconsiderada\' dentro do card da transação.';
      case 'transaction.last_update':
      ...
      case 'transaction.edit_multiple':
        return 'Editar transações';
      case 'transaction.edit_multiple_success':
        return ({required Object x}) => '${x} transações editadas com sucesso';
      case 'transaction.duplicate':
        return 'Clonar transação';
      case 'transaction.duplicate_short':
        return 'Clonar';
      case 'transaction.duplicate_warning_message':
        return 'Uma transação idêntica a esta será criada com a mesma data, deseja continuar?';
      case 'transaction.duplicate_success':
        return 'Transação clonada com sucesso';
      case 'transaction.delete':
        return 'Excluir transação';
      case 'transaction.delete_warning_message':
        return 'Essa ação é irreversível. Prefira usar o status \'Desconsiderada\' para remover a transação das suas análises. O saldo atual de suas contas e todas as suas análises serão recalculados';
      ...
      case 'transaction.next_payments.accept_dialog_title':
        return 'Aceitar transação';
      case 'transaction.next_payments.accept_dialog_msg_single':
        return 'O novo status da transação será nulo. Você pode re-editar o status dessa transação sempre que quiser';
      case 'transaction.next_payments.accept_dialog_msg':
        return ({required Object date}) =>
            'Essa ação criará uma nova transação com data ${date}. Você poderá verificar os detalhes desta transação na página de transações';
      case 'transaction.next_payments.recurrent_rule_finished':
        return 'A regra recorrente foi concluída, não há mais pagamentos a serem feitos!';
      case 'transaction.list.empty':
        return 'Nenhuma transação encontrada para exibir aqui. Adicione uma transação clicando no botão \'+\' na parte inferior';
      case 'transaction.list.searcher_placeholder':
        return 'Pesquisar por categoria, descrição...';
      case 'transaction.list.searcher_no_results':
        return 'Nenhuma transação encontrada correspondente aos critérios de pesquisa';
      case 'transaction.list.loading':
        return 'Carregando mais transações...';
      ...
      case 'transaction.filters.from_value':
        return 'A partir do valor';
      case 'transaction.filters.to_value':
        return 'Até o valor';
      case 'transaction.filters.from_value_def':
        return ({required Object x}) => 'De ${x}';
      case 'transaction.filters.to_value_def':
        return ({required Object x}) => 'Até ${x}';
      case 'transaction.filters.from_date_def':
        return ({required Object date}) => 'De ${date}';
      case 'transaction.filters.to_date_def':
        return ({required Object date}) => 'Até ${date}';
      case 'transaction.form.validators.zero':
        return 'O valor de uma transação não pode ser igual a zero';
      case 'transaction.form.validators.date_max':
        return 'A data selecionada é posterior à atual. A transação será adicionada como pendente';
      case 'transaction.form.validators.date_after_account_creation':
        return 'Você não pode criar uma transação cuja data seja anterior à data de criação da conta a que pertence';
      case 'transaction.form.validators.negative_transfer':
        return 'O valor monetário de uma transferência não pode ser negativo';
      case 'transaction.form.validators.transfer_between_same_accounts':
        return 'A conta de origem e a conta de destino não podem ser a mesma';
      ...
      case 'transaction.form.tap_to_see_more':
        return 'Toque para ver mais detalhes';
      case 'transaction.form.no_tags':
        return '-- Sem tags --';
      case 'transaction.form.description':
        return 'Comentários';
      case 'transaction.form.description_info':
        return 'Toque aqui para inserir uma descrição mais detalhada sobre esta transação';
      case 'transaction.form.exchange_to_preferred_title':
        return ({required Object currency}) =>
            'Taxa de câmbio para ${currency}';
      case 'transaction.form.exchange_to_preferred_in_date':
        return 'Na data da transação';
      case 'transaction.notes.title':
        return 'Detalhes extras sobre a Transação';
      case 'transaction.notes.title_short':
        return 'Insira informações adicionais sobre a transação.';
      case 'transaction.reversed.title':
        return 'AINDA NÃO FUNCIONA Transação inversa';
      case 'transaction.reversed.title_short':
        return 'AINDA NÃO FUNCIONA Trans. inversa';
      case 'transaction.reversed.description_for_expenses':
        return 'AINDA NÃO FUNCIONA Apesar de ser uma transação de despesa, ela tem um valor positivo. Esses tipos de transações podem ser usados para representar o retorno de uma despesa previamente registrada, como um reembolso ou o pagamento de uma dívida.';
      case 'transaction.reversed.description_for_incomes':
        return 'AINDA NÃO FUNCIONA Apesar de ser uma transação de receita, ela tem um valor negativo. Esses tipos de transações podem ser usados para anular ou corrigir uma receita que foi registrada incorretamente, para refletir um retorno ou reembolso de dinheiro ou para registrar o pagamento de dívidas.';
      ...
      case 'transaction.status.display_long':
        return 'Status da transação para Insights';
      case 'transaction.status.tr_status':
        return ({required Object status}) => 'Transação ${status}';
      case 'transaction.status.none':
        return 'Sem status';
      case 'transaction.status.insights':
        return 'Insights';
      case 'transaction.status.none_descr':
        return 'Transação sem status específico';
      case 'transaction.status.reconciled':
        return 'Considerada';
      case 'transaction.status.reconciled_descr':
        return 'Esta transação conta para seus insights e saldos.';
      case 'transaction.status.unreconciled':
        return 'Não considerada';
      case 'transaction.status.unreconciled_descr':
        return 'Esta transação ainda não foi validada e, portanto, ainda não aparece em suas contas bancárias reais. No entanto, ela conta para o cálculo de saldos e insights no Parsa';
      case 'transaction.status.notconsidered':
        return 'Desconsiderada';
      case 'transaction.status.notconsidered_descr':
        return 'Esta transação não conta para seus insights e saldos.';
      case 'transaction.status.pending':
        return 'Pendente';
      case 'transaction.status.pending_descr':
        return 'Esta transação está pendente e, portanto, não será considerada no cálculo de saldos e insights';
      case 'transaction.status.voided':
        return 'Anulada';
      case 'transaction.status.voided_descr':
        return 'Transação anulada/cancelada devido a erro de pagamento ou qualquer outro motivo. Ela não será considerada no cálculo de saldos e insights';
      ...
      case 'transaction.types.outflow':
        return ({required num n}) =>
            (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('pt'))(
              n,
              one: 'Gasto',
      ...
      case 'transfer.transfer_to':
        return ({required Object account}) => 'Transferir para ${account}';
      ...
      case 'transfer.need_two_accounts_warning_message':
        return 'São necessárias pelo menos duas contas para realizar esta ação. Se precisar ajustar ou editar o saldo atual desta conta, clique no botão de edição';
      ...
      case 'transfer.form.value_in_destiny.title':
        return 'Valor transferido no destino';
      case 'transfer.form.value_in_destiny.amount_short':
        return ({required Object amount}) => '${amount} para conta de destino';
      case 'recurrent_transactions.title':
        return 'Transações recorrentes';
      case 'recurrent_transactions.title_short':
        return 'Trans. recorrentes';
      case 'recurrent_transactions.empty':
        return 'Parece que você não tem nenhuma transação recorrente. Crie uma transação recorrente mensal, anual ou semanal e ela aparecerá aqui';
      case 'recurrent_transactions.total_expense_title':
        return 'Despesa total por período';
      case 'recurrent_transactions.total_expense_descr':
        return '* Sem considerar a data de início e término de cada recorrência';
      case 'recurrent_transactions.details.title':
        return 'Transação recorrente';
      case 'recurrent_transactions.details.descr':
        return 'As próximas transações para esta operação estão listadas abaixo. Você pode aceitar a primeira transação ou optar por ignorá-la';
      case 'recurrent_transactions.details.last_payment_info':
        return 'Esta transação é a última da regra recorrente, portanto, a regra será automaticamente excluída ao confirmar esta ação';
      case 'recurrent_transactions.details.delete_header':
        return 'Excluir transação recorrente';
      case 'recurrent_transactions.details.delete_message':
        return 'Esta ação é irreversível e não afetará as transações que você já confirmou/pagou';
      case 'account.details':
        return 'Detalhes da conta';
      case 'account.date':
        return 'Data de abertura';
      case 'account.date_sync':
        return 'Conta sincronizada desde';
      case 'account.close_date':
        return 'Data de fechamento';
      case 'account.disconnection_date':
        return 'Data de desconexão';
      case 'account.reopen':
        return 'Reabrir conta';
      case 'account.reopen_short':
        return 'Reabrir';
      case 'account.reopen_descr':
        return 'Tem certeza de que deseja reabrir esta conta?';
      ...
      case 'account.types.warning':
        return 'Uma vez escolhido o tipo de conta, ele não poderá ser alterado no futuro';
      case 'account.types.normal':
        return 'Conta corrente';
      case 'account.types.normal_descr':
        return 'Útil para registrar suas finanças do dia a dia. É a conta mais comum, permite adicionar despesas, receitas...';
      case 'account.types.saving':
        return 'Investimentos';
      case 'account.types.saving_descr':
        return 'Você só poderá adicionar e retirar dinheiro dela a partir de outras contas. Perfeito para começar a economizar';
      case 'account.types.credit':
        return 'Cartão de crédito';
      case 'account.types.credit_descr':
        return 'Conta que simula uma conta corrente, porém com um saldo negativo. Útil para simular compras parceladas, empréstimos, financiamentos, etc';
      case 'account.types.wallet':
        return 'Carteira';
      case 'account.types.wallet_descr':
        return 'Para controlar dinheiro físico (eca!). Usuários Premium terão saques automaticamente creditados nesta conta.';
      case 'account.form.name':
        return 'Nome da conta';
      case 'account.form.name_placeholder':
        return 'Ex: Conta poupança';
      case 'account.form.notes':
        return 'Notas';
      case 'account.form.notes_placeholder':
        return 'Digite algumas notas/descrição sobre esta conta';
      ...
      case 'account.form.currency_not_found_warn':
        return 'Você não tem informações sobre taxas de câmbio para esta moeda. 1.0 será usado como a taxa de câmbio padrão. Você pode modificar isso nas configurações';
      case 'account.form.already_exists':
        return 'Já existe outra com o mesmo nome, por favor escreva outro';
      case 'account.form.tr_before_opening_date':
        return 'Existem transações nesta conta com uma data anterior à data de abertura';
      case 'account.form.iban':
        return 'Número de Conta';
      case 'account.form.swift':
        return 'Agencia';
      case 'account.disconnect.title':
        return 'Desconectar Banco';
      case 'account.disconnect.warning_header':
        return 'Desconectar conta?';
      case 'account.disconnect.warning_text':
        return 'Esta ação cancelerá seu consentimento com o seu banco e não poderemos mais sincronizar suas transações. Esta ação afetará também outros produtos do mesmo banco. Suas transações ainda permanecerão guardadas no Parsa.';
      case 'account.disconnect.success':
        return 'Conta desconectada com sucesso';
      case 'account.remove.title':
        return 'Remover Conta';
      case 'account.remove.warning_header':
        return 'Deletar?';
      case 'account.remove.warning_text':
        return 'Está ação irá remover esta conta da interface do Parsa, mas seu banco e outras contas continuarão sendo sincronizadas. Esta ação é totalmente reversível. Você deseja continuar?';
      case 'account.remove.success':
        return 'Conta removida com sucesso';
      case 'account.restore.title':
        return 'Restaurar Conta';
      case 'account.restore.warning_header':
        return 'Restaurar?';
      case 'account.restore.warning_text':
        return 'Está ação irá trazer de volta para sincronização automática continua esta conta que você parou de sincronizar. Você gostaria de prosseguir com esta ação?';
      case 'account.restore.success':
        return 'Conta restaurada com sucesso.';
      case 'account.restore.in_progress':
        return 'Restauração da Conta em Andamento. Você pode continuar usando o app.';
      case 'account.delete_openfinance.title':
        return 'Remover Banco';
      case 'account.delete_openfinance.warning_header':
        return 'Deletar?';
      case 'account.delete_openfinance.warning_text':
        return 'Está ação irá remover seu consentimento com o seu banco, interromperá a sincronização de todas as contas e transações neste banco e excluirá todas as suas transações desta conta no Parsa. Deseja prosseguir?';
      case 'account.delete_openfinance.success':
        return 'Conta deletada com sucesso';
      case 'account.delete.warning_header':
        return 'Excluir conta?';
      case 'account.delete.warning_text':
        return 'Essa ação excluirá essa conta e todas as suas transações';
      ...
      case 'account.close.warn':
        return 'Esta conta não aparecerá mais em determinados listagens e você não poderá criar transações nela com uma data posterior à especificada abaixo. Esta ação não afeta nenhuma transação ou saldo, e você também pode reabrir esta conta a qualquer momento.';
      case 'account.close.should_have_zero_balance':
        return 'Você deve ter um saldo atual de 0 nesta conta para fechá-la. Por favor, edite a conta antes de continuar';
      case 'account.close.should_have_no_transactions':
        return 'Esta conta possui transações após a data de fechamento especificada. Exclua-as ou edite a data de fechamento da conta antes de continuar';
      ...
      case 'account.connection_errors.not_subscribed':
        return 'Você ainda não é assinante do plano Premium. Por favor, assine o plano Premium para conectar suas contas com o Open Finance.';
      case 'account.connection_errors.limit_reached':
        return 'Você atingiu o limite de 3 contas conectadas. Tente desconectar uma conta para adicionar outra.';
      case 'account.connection_errors.daily_limit_reached':
        return 'O sistema atingiu o limite de conexões diárias. Por favor, tente novamente amanhã.';
      case 'account.connection_errors.default_message':
        return 'Não foi possível conectar no momento. Tente novamente mais tarde.';
      case 'currencies.currency_converter':
        return 'Conversor de moedas';
      case 'currencies.currency':
        return 'Moeda';
      case 'currencies.currency_manager':
        return 'Gerenciador de moedas';
      case 'currencies.currency_manager_descr':
        return 'Configure sua moeda e suas taxas de câmbio com outras';
      case 'currencies.preferred_currency':
        return 'Moeda preferida/base';
      case 'currencies.change_preferred_currency_title':
        return 'Alterar moeda preferida';
      case 'currencies.change_preferred_currency_msg':
        return 'Todas as insights e orçamentos serão exibidos nesta moeda a partir de agora. Contas e transações manterão a moeda que possuíam. Todas as taxas de câmbio salvas serão excluídas se você executar esta ação. Deseja continuar?';
      case 'currencies.form.equal_to_preferred_warn':
        return 'A moeda não pode ser igual à moeda do usuário';
      case 'currencies.form.specify_a_currency':
        return 'Por favor, especifique uma moeda';
      case 'currencies.form.add':
        return 'Adicionar taxa de câmbio';
      case 'currencies.form.add_success':
        return 'Taxa de câmbio adicionada com sucesso';
      case 'currencies.form.edit':
        return 'Editar taxa de câmbio';
      case 'currencies.form.edit_success':
        return 'Taxa de câmbio editada com sucesso';
      case 'currencies.delete_all_success':
        return 'Taxas de câmbio excluídas com sucesso';
      case 'currencies.historical':
        return 'Taxas históricas';
      ...
      case 'currencies.empty':
        return 'Adicione taxas de câmbio aqui para que se você tiver contas em moedas diferentes da sua moeda base, nossos gráficos sejam mais precisos';
      case 'currencies.select_a_currency':
        return 'Selecione uma moeda';
      case 'currencies.search':
        return 'Pesquise por nome ou código da moeda';
      case 'tags.display':
        return ({required num n}) =>
            (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('pt'))(
              n,
      ...
      case 'tags.empty_list':
        return 'Você ainda não criou nenhuma tag. Tags e categorias são uma ótima maneira de categorizar suas transações';
      ...
      case 'tags.already_exists':
        return 'Este nome de tag já existe. Talvez você queira editá-lo';
      case 'tags.edit':
        return 'Editar tag';
      case 'tags.edit_success':
        return 'Tag editada com sucesso';
      case 'tags.delete_success':
        return 'Tag excluída com sucesso';
      case 'tags.delete_warning_header':
        return 'Excluir tag?';
      case 'tags.delete_warning_message':
        return 'Essa ação não excluirá as transações que possuem essa tag.';
      case 'tags.no_tags':
        return 'Transação sem tags. Clique aqui para adicionar uma tag.';
      ...
      case 'categories.already_exists':
        return 'O nome desta categoria já existe. Talvez você queira editá-la';
      ...
      case 'categories.make_parent':
        return 'Tornar categoria';
      case 'categories.make_child':
        return 'Tornar subcategoria';
      ...
      case 'categories.make_child_success':
        return 'Subcategorias criadas com sucesso';
      case 'categories.merge':
        return 'Mesclar com outra categoria';
      ...
      case 'categories.merge_success':
        return 'Categoria mesclada com sucesso';
      ...
      case 'budgets.days_to_start':
        return 'dias para começar';
      case 'budgets.since_expiration':
        return 'dias desde a expiração';
      case 'budgets.no_budgets':
        return 'Os dados de orçamentos ainda não são salvos na nuvem. Parece não haver orçamentos para exibir nesta seção. Comece criando um orçamento clicando no botão abaixo';
      case 'budgets.delete':
        return 'Excluir orçamento';
      case 'budgets.delete_warning':
        return 'Essa ação é irreversível. Categorias e transações referentes a esta cota não serão excluídas';
      case 'budgets.form.title':
        return 'Adicionar um orçamento';
      ...
      case 'budgets.form.negative_warn':
        return 'Os orçamentos não podem ter um valor negativo';
      ...
      case 'budgets.details.no_transactions':
        return 'Parece que você não fez nenhuma despesa relacionada a este orçamento';
      case 'backup.export.title':
        return 'Exportar seus dados';
      case 'backup.export.title_short':
        return 'Exportar';
      case 'backup.export.all':
        return 'Backup completo';
      case 'backup.export.all_descr':
        return 'Exporte todos os seus dados (contas, transações, orçamentos, configurações...). Importe-os novamente a qualquer momento para não perder nada.';
      case 'backup.export.transactions':
        return 'Backup de transações';
      case 'backup.export.transactions_descr':
        return 'Exporte suas transações em CSV para que você possa analisá-las mais facilmente em outros programas ou aplicativos.';
      case 'backup.export.description':
        return 'Baixe os dados da suas transações em formato CSV. Recomendamos o uso do Google Sheets para abrir o arquivo por primeira vez - de lá você poderá exportar o arquivo para o Excel.';
      case 'backup.export.dialog_title':
        return 'Salvar/Enviar arquivo';
      case 'backup.export.success':
        return ({required Object x}) =>
            'Arquivo salvo/baixado com sucesso em ${x}';
      case 'backup.export.error':
        return 'Erro ao baixar o arquivo. Entre em contato com o desenvolvedor via lozin.technologies@gmail.com';
      case 'backup.import.title':
        return 'Importar seus dados';
      ...
      case 'backup.import.restore_backup_descr':
        return 'Importe um banco de dados salvo anteriormente do Parsa. Esta ação substituirá todos os dados atuais do aplicativo pelos novos dados';
      case 'backup.import.restore_backup_warn_description':
        return 'Ao importar um novo banco de dados, você perderá todos os dados atualmente salvos no aplicativo. Recomenda-se fazer um backup antes de continuar. Não carregue aqui nenhum arquivo cuja origem você não conheça, carregue apenas arquivos que você tenha baixado anteriormente do Parsa';
      case 'backup.import.restore_backup_warn_title':
        return 'Sobrescrever todos os dados';
      case 'backup.import.select_other_file':
        return 'Selecionar outro arquivo';
      case 'backup.import.tap_to_select_file':
        return 'Toque para selecionar um arquivo';
      case 'backup.import.manual_import.title':
        return 'Importar histórico manualmente';
      case 'backup.import.manual_import.descr':
        return 'Importe transações de um arquivo .csv manualmente. Se você estiver usando sincronização do Open Finance, por favor não inclua transações do período de sincronização para evitar duplicidade.';
      case 'backup.import.manual_import.default_account':
        return 'Conta padrão';
      case 'backup.import.manual_import.remove_default_account':
        return 'Remover conta padrão';
      case 'backup.import.manual_import.default_category':
        return 'Categoria padrão';
      case 'backup.import.manual_import.select_a_column':
        return 'Selecione uma coluna do .csv';
      case 'backup.import.manual_import.steps.0':
        return 'Selecione seu arquivo';
      case 'backup.import.manual_import.steps.1':
        return 'Coluna para quantidade';
      case 'backup.import.manual_import.steps.2':
        return 'Coluna para conta';
      case 'backup.import.manual_import.steps.3':
        return 'Coluna para categoria';
      case 'backup.import.manual_import.steps.4':
        return 'Coluna para data';
      case 'backup.import.manual_import.steps.5':
        return 'outras colunas';
      case 'backup.import.manual_import.steps_descr.0':
        return 'Selecione um arquivo .csv do seu dispositivo. Certifique-se de que ele tenha uma primeira linha que descreva o nome de cada coluna';
      case 'backup.import.manual_import.steps_descr.1':
        return 'Selecione a coluna onde o valor de cada transação é especificado. Use valores negativos para despesas e valores positivos para receitas. Use ponto como separador decimal';
      case 'backup.import.manual_import.steps_descr.2':
        return 'Selecione a coluna onde a conta à qual cada transação pertence é especificada. Você também pode selecionar uma conta padrão caso não consigamos encontrar a conta que deseja. Se uma conta padrão não for especificada, criaremos uma com o mesmo nome';
      case 'backup.import.manual_import.steps_descr.3':
        return 'Especifique a coluna onde o nome da categoria da transação está localizado. Você deve especificar uma categoria padrão para que possamos atribuir essa categoria às transações, caso a categoria não possa ser encontrada';
      case 'backup.import.manual_import.steps_descr.4':
        return 'Selecione a coluna onde a data de cada transação é especificada. Se não for especificado, as transações serão criadas na data atual';
      case 'backup.import.manual_import.steps_descr.5':
        return 'Especifique as colunas para outros atributos opcionais da transação';
      case 'backup.import.manual_import.success':
        return ({required Object x}) => 'Importado com sucesso ${x} transações';
      case 'backup.import.success':
        return 'Importação realizada com sucesso';
      case 'backup.import.cancelled':
        return 'A importação foi cancelada pelo usuário';
      case 'backup.import.error':
        return 'Erro ao importar arquivo. Entre em contato com o desenvolvedor via lozin.technologies@gmail.com';
      case 'backup.about.title':
        return 'Informações sobre seu banco de dados';
      ...
      case 'settings.description':
        return 'Configure o Parsa do seu jeito.';
      case 'settings.edit_profile':
        return 'Editar perfil';
      case 'settings.lang_section':
        return 'Idioma e textos';
      case 'settings.lang_title':
        return 'Idioma do aplicativo';
      case 'settings.lang_descr':
        return 'Idioma em que os textos serão exibidos no aplicativo';
      case 'settings.locale':
        return 'Região';
      case 'settings.locale_descr':
        return 'Defina o formato a ser usado para datas, números...';
      case 'settings.locale_warn':
        return 'Ao mudar de região, o aplicativo será atualizado';
      ...
      case 'settings.amoled_mode_descr':
        return 'Use um papel de parede preto puro sempre que possível. Isso ajudará um pouco na bateria de dispositivos com telas AMOLED';
      case 'settings.dynamic_colors':
        return 'Cores dinâmicas';
      case 'settings.dynamic_colors_descr':
        return 'Use a cor de destaque do sistema sempre que possível';
      case 'settings.accent_color':
        return 'Cor de destaque';
      case 'settings.accent_color_descr':
        return 'Escolha a cor que o aplicativo usará para destacar certas partes da interface';
      case 'settings.security.title':
        return 'Privacidade';
      case 'settings.security.private_mode_at_launch':
        return 'Modo privado ao iniciar';
      case 'settings.security.private_mode_at_launch_descr':
        return 'Inicie o aplicativo no modo privado por padrão';
      case 'settings.security.private_mode':
        return 'Modo privado';
      case 'settings.security.private_mode_descr':
        return 'Oculte todos os valores monetários';
      case 'settings.security.private_mode_activated':
        return 'Modo privado ativado';
      case 'settings.security.private_mode_deactivated':
        return 'Modo privado desativado';
      case 'more.title':
        return 'Menu';
      case 'more.title_long':
        return 'Menu e Preferências';
      case 'more.data.display':
        return 'Dados';
      case 'more.data.display_descr':
        return 'Exporte os dados da suas transações.';
      case 'more.data.delete_all':
        return 'Excluir meus dados';
      case 'more.data.delete_all_header1':
        return 'Pare aí, padawan ⚠️⚠️';
      case 'more.data.delete_all_message1':
        return 'Tem certeza de que deseja continuar? Todos os seus dados serão excluídos permanentemente e não poderão ser recuperados';
      case 'more.data.delete_all_header2':
        return 'Último passo ⚠️⚠️';
      case 'more.data.delete_all_message2':
        return 'Ao excluir uma conta, você excluirá todos os seus dados pessoais armazenados. Suas contas, transações, orçamentos e categorias serão excluídos e não poderão ser recuperados. Você concorda?';
      case 'more.subscribe.display':
        return 'Assinatura';
      case 'more.subscribe.description':
        return 'Assine o Parsa para desbloquear todos os recursos Premium.';
      case 'more.subscribe.title':
        return 'Assinatura Premium';
      case 'more.subscribe.subscribe':
        return 'Assinar';
      case 'more.subscribe.subscribe_for':
        return ({required Object price}) => 'Assinar por ${price}';
      case 'more.subscribe.confirm_subscription':
        return 'Confirmar assinatura';
      case 'more.subscribe.confirm_message':
        return ({required Object price}) =>
            'Você está prestes a assinar o Parsa Premium por ${price}. Deseja continuar?';
      case 'more.subscribe.no_plans_available':
        return 'Nenhum plano disponível no momento';
      case 'more.subscribe.success':
        return 'Assinatura realizada com sucesso!';
      case 'more.subscribe.error':
        return 'Erro ao processar a assinatura. Por favor, tente novamente.';
      case 'more.subscribe.cancel':
        return 'Cancelar';
      case 'more.about_us.display':
        return 'Informações';
      case 'more.about_us.description':
        return 'Informações sobre o Parsa, entre em contato conosco, envie sugestões, etc. ';
      ...
      case 'more.about_us.legal.terms':
        return 'Termos de Uso e Serviço';
      case 'more.about_us.legal.licenses':
        return 'Licenças';
      case 'more.about_us.project.about_us':
        return 'Sobre o Parsa';
      ...
      case 'more.about_us.project.contributors_descr':
        return 'Todos os desenvolvedores que ajudaram o Parsa a crescer';
      case 'more.about_us.project.contact':
        return 'Entre em contato';
      case 'more.help_us.display':
        return 'Ajude-nos';
      case 'more.help_us.description':
        return 'Descubra como você pode ajudar o Parsa a ficar cada vez melhor';
      case 'more.help_us.rate_us':
        return 'Nos avalie';
      case 'more.help_us.rate_us_descr':
        return 'Qualquer avaliação é bem-vinda!';
      case 'more.help_us.share':
        return 'Compartilhar o Parsa';
      case 'more.help_us.share_descr':
        return 'Compartilhe nosso aplicativo com amigos e familiares';
      case 'more.help_us.share_text':
        return 'Parsa! O melhor aplicativo de finanças pessoais. Baixe aqui';
      case 'more.help_us.thanks':
        return 'Obrigado!';
      case 'more.help_us.thanks_long':
        return 'Suas contribuições para o Parsa e outros projetos de código aberto, grandes e pequenos, tornam possíveis grandes projetos como este. Obrigado por dedicar seu tempo para contribuir.';
      case 'more.help_us.donate':
        return 'Faça uma doação';
      case 'more.help_us.donate_descr':
        return 'Com sua doação, você ajudará o aplicativo a continuar recebendo melhorias. Que melhor maneira de agradecer pelo trabalho feito do que me convidar para um café?';
      case 'more.help_us.donate_success':
        return 'Doação realizada. Muito obrigado pela sua contribuição! ❤️';
      case 'more.help_us.donate_err':
        return 'Oops! Parece que houve um erro ao receber seu pagamento';
      case 'more.help_us.report':
        return 'Entre em contato.';
      case 'auth.login_button':
        return 'Fazer Login no Parsa';
      case 'auth.login_reason':
        return 'Por favor, confirme sua biometria para continuar. ';
      case 'auth.login_error':
        return 'Erro ao fazer login. Por favor, verifique suas credenciais e conexão de rede.';
      case 'auth.biometric_failed':
        return 'Autenticação biométrica falhou. Por favor, faça o login novamente.';
      case 'auth.app_name':
        return 'Parsa';
      default:
        return null;
